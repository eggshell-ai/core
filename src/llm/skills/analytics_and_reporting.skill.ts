...
export const AnalyticsAndReportingSkill: Skill = {
  name: 'analytics_and_reporting',
  description: 'Teaches the agent how to create backend analytics aggregators and dashboards',
  category: 'analytics',
  tags: ['analytics', 'reporting', 'dashboard'],
  content: `# Analytics and Reporting Skill
